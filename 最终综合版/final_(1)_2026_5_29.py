...
SYS_WAIT_BOARD_READY = 2
SYS_SEARCH_BOARD = 3
SYS_MOVE_TO_START = 4
SYS_WAIT_LASER_ON_ACK = 5
SYS_DRAWING = 6
SYS_WAIT_LASER_OFF_ACK = 7
...
def main():
    ...
    print("开激光/关激光/停止扫描/画板ready：03 01/02/03/04 00 00 00 30")
        ...
        while True:
            ...
            if sys_state == SYS_RECOGNIZE_TARGET:
                if warped_a4 is not None:
                    ...
                    if shape_info is not None and shape_info.get("shape") in ("square", "triangle", "trapezoid", "circle"):
                        ...
                        if len(target_points) > 0:
                            ...
                            # 状态24~25：STM32 慢速扫描，香橙派检测到黑框大致居中后发停止扫描
                            elif task_state in (0x24, 0x25):
